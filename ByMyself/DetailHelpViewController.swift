...
class DetailHelpViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if sIndex == 0 {
            ...
            myTextView.text = "設定した目標の期限(いつまでに達成するか)を設定しましょう。\nこれはものすごく大事な作業で\n期限を決めることで\nよりその中でどのように行動すれば良いか考えることで\n自然と行動が工夫されていきます。大きな目標の期限は\n一度決めてしまうと達成するまで変更できません。"
            ...
            myTextView.text = "アラームを設定し目標を達成するよう自分へ促しましょう。人間は忘れやすい生き物です。毎日覚えなくてはならないことが出てくるため\n日々過ごしていると忘れがちになってしまいます。\nそのためもう一度目標への意識の再確認を行いましょう。"
